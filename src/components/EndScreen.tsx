...
export default function EndScreen({ onRestart, isVisible }: EndScreenProps) {
  ...
  return (
    <div
      className={`absolute inset-0 z-40 flex flex-col items-center justify-center transition-opacity duration-2000 ${isVisible ? 'opacity-100' : 'opacity-0 pointer-events-none'
        }`}
    >
